...
terminate(
    ...
    %% The close send batches the packet into an updated socket_state;
    %% that updated state must be the one flushed below, or the close
    %% never reaches the wire and the peer holds a phantom connection
